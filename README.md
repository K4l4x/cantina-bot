# CantinaBot
Providing information about current menus, ingredients and buisness hours of a university cantina.
...
- Navigate to `CantinaBot` folder
- Select `CantinaBot.bot` file
...
msbot clone services --name "CantinaBot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
