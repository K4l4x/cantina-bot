...
class MenuBuilder {
    async buildMenus() {
        ...
        const rawDateTime = await CantinaScraper.prototype.requestBody().then(function(dates) { return dates; });
        const menuTypes = await CantinaScraper.prototype.requestBody().then(function(types) { return types; });
        // const menusPerDay = await MenuBuilder.getMenusPerDay();
        // const menuPrices = await MenuBuilder.getPricesPerDay();
        // const menuDescriptions = await MenuBuilder.getRawMenus();
